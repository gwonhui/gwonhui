...
<form action="reportPro.jsp" method="post" name="frm" enctype="multipart/form-data">
<table id="notice">
<tr><th>이름</th>
	<td><input type="hidden" name="name" value="<%=id %>"><%=id %></td></tr>
<tr><th>신고이유 </th>
	<td><select name="reason">
	 	<option value="부적절한내용" selected="selected">부적절한 내용</option>
	 	<option value="음란성및 혐오글">음란성및 혐오글</option>
	 	<option value="게시판에 맞지않는 글">게시판에 맞지않는 글</option>
