...
<%
	...
	bean.setRe_ref(Integer.parseInt(multi.getParameter("re_ref")));
	bean.setRe_lev(Integer.parseInt(multi.getParameter("re_lev")));
	bean.setRe_seq(Integer.parseInt(multi.getParameter("re_seq")));
	// 파일이름 => 자바빈 저장
	// 원래 파일이름
