...
if (id.equals("admin") ) { //세션값과 작성자를 일치시키려면???
	
	%>
	<input type="button" value="글삭제" class="btn" onclick="location.href='adminDelete.jsp?num=<%=board.getNum()%>&pageNum=<%=pageNum %>'">
	
	<%
}
%>
<input type="button" value="목록보기" class="btn" onclick="location.href='../admin/board.jsp?pageNum=<%=pageNum%>'">
</div>
